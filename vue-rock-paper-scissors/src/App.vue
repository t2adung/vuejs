...
/* Trong Vue 3, ref là một hàm được sử dụng để tạo một biến tham chiếu (reference) có khả năng theo dõi và tự động cập nhật giao diện người dùng khi giá trị của biến này thay đổi. 
Biến tham chiếu (ref) thường được sử dụng để lưu trữ các giá trị dữ liệu có khả năng thay đổi trong ứng dụng Vue.*/
const wins = ref(0) // tạo một biến tham chiếu có tên là losses và khởi tạo nó với giá trị ban đầu là 0.
const draws = ref(0)
const losses = ref(0) 
...
<template>
  <div v class="bg-gray-700 text-white text-center min-h-screen flex flex-col">
